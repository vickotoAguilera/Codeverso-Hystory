    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-background text-foreground">
      <div className="z-10 max-w-5xl w-full items-center justify-center font-mono text-sm flex flex-col gap-8">
        ...
        <div className="flex gap-4">
          <button className="btn-shiny px-8 py-3 rounded-full font-bold text-primary border-primary/20 hover:scale-105 active:scale-95 transition-transform">
            NUEVA PARTIDA
          </button>
          <button className="px-8 py-3 rounded-full font-bold bg-secondary/20 text-secondary border border-secondary/30 hover:bg-secondary/30 transition-colors">
            CARGAR SESIÓN
          </button>
        </div>
